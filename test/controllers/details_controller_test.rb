...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { cantidad: @detail.cantidad, descripcion: @detail.descripcion, item_id: @detail.item_id, monto: @detail.monto, precio: @detail.precio, user_id: @detail.user_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { cantidad: @detail.cantidad, descripcion: @detail.descripcion, item_id: @detail.item_id, monto: @detail.monto, precio: @detail.precio, user_id: @detail.user_id } }
