...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { empresa: @parameter.empresa, mes: @parameter.mes, origen: @parameter.origen } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { empresa: @parameter.empresa, mes: @parameter.mes, origen: @parameter.origen } }
